...
#No le afectan los Symlinks de ncurses. Ok.
#Hay que modificar el Makefile para cambiar:
#
#NCURSES_CFLAGS = -D_GNU_SOURCE -I/usr/include/ncursesw
#NCURSES_LIBS = -lncursesw -ltinfo
#por
#
#NCURSES_CFLAGS = -D_GNU_SOURCE -I/tools/include
