# Instalador de cloog cross-compile them into /tools
...
echo -e "\nInstalacion de $nombre_dir cross-compile them into /tools" >> $FILE_BITACORA
...
registro_error "sed '/cmake/d' Makefile.orig > Makefile"
