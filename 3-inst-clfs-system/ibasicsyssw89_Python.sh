...
#No se puede instalar en --libdir=/usr/lib/64. Así no funciona.
#Instalaré solo la versión 64 bit, a ver qué pasa.
#He construido el paquete qi, y en tosh funciona.
