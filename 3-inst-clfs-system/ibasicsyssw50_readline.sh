...
#ver versión 32 bit para comentarios. Esta la quiero dejar limpia, para ver
#qué aspecto tiene.

make SHLIB_LIBS="-L/lib64 -lncursesw"
...
#¿Tiene sentdo instalar en 32 y 64 bit la documentación? Seguramente no.
